...
const Properties = () => {
  ...
  // Search state
  const [saleRent, setSaleRent] = useState("all");
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              padding: "8px 20px",
              border: saleRent === "all" ? "2px solid #14b8a6" : "2px solid #e2e8f0",
              borderRadius: "8px",
              background: saleRent === "all" ? "#14b8a6" : "transparent",
              color: saleRent === "all" ? "#fff" : "#64748b",
              fontWeight: "600",
              fontSize: "14px",
              cursor: "pointer",
        ...
        <div style={{
          ...
          {[
            ...
            if (type.showFor === "sale" && saleRent !== "sale" && saleRent !== "all") return null;
            if (type.showFor === "rent" && saleRent !== "rent" && saleRent !== "all") return null;
            return (
              <button
                key={type.key}
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ color: "#64748b", fontSize: "13px" }}>
            {saleRent === "all" ? "All" : saleRent === "sale" ? "For Sale" : "For Rent"}
          </span>
        </div>
        ...
        {filteredProperties.length === 0 ? (
          ...
          <div className="properties-grid" style={{
            ...
            {filteredProperties.map((p) => (
              ...
              >
                <div className="property-card-img" style={{ position: "relative", height: "200px", background: "#e2e8f0", overflow: "hidden" }}>
                  {p.images?.[0] ? (
                    <img
